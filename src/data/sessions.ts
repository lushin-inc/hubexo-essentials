...
export const sessions: Session[] = [
  ...
  },
  {
    ...
    date: 'July 16',
    label: 'Session Four',
    title: 'The Up-Front Contract',
    accent: false,
    topics: ['Time · Agenda · Outcome', "Make It Okay to Say No", 'Go/No-Go Calls'],
    extraTopics: 4,
    concepts: [
      {
        id: 's4-mismatched-expectations',
        category: 'Foundation',
        title: "When a Deal Stalls and You Can't Tell Why",
        concept: 'Mismatched Expectations',
        points: [
          'Most stalled deals come from **mismatched expectations** — you and the buyer want different things from the meeting.',
          'You hear it as "let me take it to the team," "send me a trial," or "not in the budget."',
          'Those are usually **stalls or posturing**, not real objections.',
          'Line the expectations up front and the **conflict disappears**.',
        ],
      },
      {
        id: 's4-upfront-contract',
        category: 'Tool',
        title: 'How to Stop Guessing Where a Meeting Stands',
        concept: 'The Up-Front Contract',
        diagram: 'upfrontContract',
        fullWidth: true,
        points: [
          'An up-front contract is a **mutual agreement** on what happens in a meeting — set **before it starts**.',
          'Three parts: **Time** (how long), **Agenda** (what we cover), **Outcome** (what we decide at the end).',
          'No surprises for either side, and you follow a **process instead of improvising**.',
          'Think of a dentist walking you through each step — it **kills the anxiety**.',
        ],
      },
      {
        id: 's4-outcome',
        category: 'Qualifying',
        title: 'The Part Reps Skip That Costs Them',
        concept: 'Nail the Outcome',
        points: [
          'Reps set time and agenda but skip the **outcome** — the most important part.',
          'Name the decision you\'ll both make **at the start** of the call.',
          'That takes away the **fear of asking for commitment** later.',
          'No more awkward "so... what happens now?" endings.',
        ],
      },
      {
        id: 's4-okay-to-say-no',
        category: 'Mindset',
        title: "When You're Afraid to Hear No",
        concept: 'Make It Safe to Say No',
        points: [
          'Tell the prospect up front that **"no" is a perfectly fine answer**.',
          'When no is safe, they **stop dodging** and start being honest.',
          "A clear no beats getting **ghosted** every time.",
          'This matters most with conflict-averse buyers who hate letting you down.',
        ],
      },
      {
        id: 's4-equal-business-stature',
        category: 'Attitude',
        title: 'When You Feel One-Down in the Room',
        concept: 'Equal Business Stature',
        points: [
          'Sell **adult to adult** — you and the buyer are equals.',
          'Drop the **games, posturing, and desperation** on both sides.',
          'Being transparent about your process **builds trust**, not weakness.',
          'Respecting their time and being straight makes you **easier to buy from**.',
        ],
      },
      {
        id: 's4-go-no-go',
        category: 'Process',
        title: 'How to Clear Out Zombie Deals',
        concept: 'The Go/No-Go Call',
        points: [
          'Schedule a **decision call** that asks the prospect to confirm yes or no.',
          'Give them an **easy opt-out**: "if it\'s not a fit, just email me to cancel."',
          'Either answer is a win — you **stop wasting time** on deals that won\'t close.',
          'A day-before **demo reminder** wakes up their urgency (and sometimes clears the deal).',
        ],
      },
      {
        id: 's4-book-the-next-step',
        category: 'Behavior',
        title: 'How to Get Off the Hamster Wheel',
        concept: 'Always Book the Next Step',
        points: [
          'End **every** interaction with the next step already **on the calendar**.',
          'Put the **decision-maker** on the invite so the right people show up.',
          'A tentative time you can move beats a **vague "I\'ll follow up."**',
          'No planned next step = **chasing ghosts**.',
        ],
      },
    ],
  },
